    ...
    <div className="flex flex-col items-center text-center min-h-[550px] mx-6">
      ...
      <div className='bg-[#232323] w-full sm:w-[920px] mt-10 h-full sm:h-[568px] p-8 rounded-[20px] '>
        <div className='space-y-16'>
          <Input
            ...
            classNames={{
              ...
              inputWrapper: 'bg-text-in-bg data-[hover=true]:bg-text-in-bg group-data-[focus=true]:bg-text-in-bg h-[52px] px-5',
            }}
          />
          <Input
            isRequired
        ...
        <div className='flex sm:flex-col gap-6 items-center justify-between'>
          ...
          <h4 className='font-AzeretMono mt-5 flex justify-end text-white/55 text-xs sm:text-sm cursor-pointer'>Forgot password</h4>
        </div>
        ...
        <div className='flex justify-center items-center gap-2 mt-7'>
          ...
          <Link href='/signup' prefetch={true} ><h4 className='font-AzeretMono text-main-color text-sm '>Sign up</h4></Link>
        </div>
      </div>
    </div>
  );
