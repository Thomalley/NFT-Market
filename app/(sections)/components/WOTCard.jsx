  ...
  return (
    ...
    >
      <Tooltip content="See more">
        <Card
          className='w-[100%] h-fit lg:h-80 2xl:h-100 mt-4 text-justify rounded-4xl p-5 bg-[#1E1E1E] shadow-card-shadow hover:scale-[1.01] cursor-pointer transform duration-300'
        >
          <CardBody>
            ...
            {positions[positionIndexes[index]] === 'center' && (
              <Button className='hidden sm:block w-28 h-11 bg-light text-text-in-bg font-extrabold text-sm px-4 absolute z-10 bottom-0 left-[109px]'>
                Place Bid
              </Button>
            )}
          </CardBody>
