...
export default function Footer() {
  ...
  return (
    <div className={`${['/signup', '/login', '/faqs'].includes(pathName) ? 'bg-[#111111]' : ''} h-fit`}>
      <div className='max-w-[1100px] mx-auto mt-14 py-10'>
        <div className='flex gap-12'>
          ...
          <div className='flex flex-col'>
            ...
            <div className={`${azeretMono.className} text-white/55 font-normal text-sm tracking-wider space-y-1 mt-4`}>
              <h3 >All NFTs</h3>
          ...
          <div className='flex flex-col'>
            ...
            <h1 className='font-extrabold text-lg mt-7'>Join the community</h1>
        ...
        <div className={`flex justify-between ${azeretMono.className}`}>
